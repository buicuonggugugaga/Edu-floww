        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              borderColor: activeTab === tab.key ? "transparent" : "rgba(255,255,255,0.1)",
            }}
...
const styles: Record<string, React.CSSProperties> = {
  ...
  headerInfo: { flex: 1 },
  title: { fontSize: 26, fontWeight: 800, color: "#fff", margin: "0 0 6px", display: "flex", alignItems: "center", gap: 10 },
  ...
  emptyIcon: { display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 16, color: "rgba(255,255,255,0.4)" },
  emptyTitle: { fontSize: 20, fontWeight: 700, color: "#fff", margin: "0 0 8px" },
  emptyText: { fontSize: 14, color: "rgba(255,255,255,0.5)", lineHeight: 1.6, margin: "0 0 24px" },
  quickStats: {
    display: "flex",
    justifyContent: "center",
    gap: 32,
  ...
  goalLabel: { fontSize: 13, color: "rgba(255,255,255,0.5)" },
  goalValue: { fontSize: 18, fontWeight: 700, color: "#fff" },
  goalProgress: {
    height: 10,
  ...
  goalStatus: { fontSize: 13, color: "rgba(255,255,255,0.5)" },
  tabs: {
    display: "flex",
    gap: 8,
    marginBottom: 20,
  ...
  subjectDetailTitle: { fontSize: 18, fontWeight: 700, color: "#fff", margin: 0 },
  subjectDetailStats: { fontSize: 14, color: "rgba(255,255,255,0.5)", margin: "6px 0 0" },
  closeSubjectBtn: {
    width: 32,
    height: 32,
    borderRadius: "50%",
  ...
  subjectTopicStatLabel: { fontSize: 11, color: "rgba(255,255,255,0.5)" },
  subjectTopicBar: {
    height: 6,
    background: "rgba(255,255,255,0.1)",
    borderRadius: 99,
  ...
  subjectTopicBarFill: { height: "100%", borderRadius: 99, background: "linear-gradient(90deg, #667eea, #764ba2)" },
  subjectTopicAdvice: {
    fontSize: 13,
  ...
  subjectTopicExercisesLabel: { fontSize: 12, fontWeight: 600, color: "rgba(255,255,255,0.7)", marginBottom: 8 },
  exerciseChecklist: { display: "flex", flexDirection: "column", gap: 6 },
  exerciseCheckItem: { display: "flex", alignItems: "center", gap: 8, fontSize: 12, color: "rgba(255,255,255,0.6)" },
  checkbox: { fontSize: 14, color: "rgba(255,255,255,0.4)" },
  sectionTitle: {
    fontSize: 16,
    fontWeight: 700,
    color: "#fff",
